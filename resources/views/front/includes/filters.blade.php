<aside class="sidebar shop-sidebar sticky-sidebar-wrapper sidebar-fixed">
    ...
    <div class="sidebar-content scrollable">
        ...
        <div class="sticky-sidebar">
            ...
            <input  name="cat" value="{{$cat}}" type="hidden" id='cat_vaue'>
...
<script>
   ...
   var price_limit=$('input[name="price_limit"]:checked').val();
    ...
    var ajax_parameters = cat_vaue+'/'+colors+'/'+sizes+'/'+min_max+'/'+price_limit;

    
                 $.ajax({
                type: "GET",
                url: '{{url('product_category_filter')}}/' + ajax_parameters,
