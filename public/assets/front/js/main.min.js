...
$.extend($.easing, {
    ...
    Wolmart.$window = t(window), Wolmart.$body = t(document.body), Wolmart.status = "", Wolmart.isIE = navigator.userAgent.indexOf("Trident") >= 0, Wolmart.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Wolmart.call = function (t, e) {
        ...
        return new IntersectionObserver(function (e) {
            for (var i = 0; i < e.length; i++) {
                var o = e[i];
                if (o.intersectionRatio > 0) if ("string" == typeof a) Function("return " + functionName)(); else {
                    a.call(t(o.target))
                }
            }
        ...
        return e.prototype.init = function (e, a) {
            ...
            var a = window.pageYOffset + e.offsetTop, i = this.$el;
        ...
        t.fn.isotope && Wolmart.$(e).on("click", function (e) {
            ...
            t(o ? o : ".grid").isotope({filter: i}).isotope("on", "arrangeComplete", function () {
    ...
    var e = {
        init: function () {
            Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initProductType("slideup"), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", function (e) {
                ...
                a.hasClass("disabled") ? alert("Please select some product options before adding this product to your cart.") : (a.toggleClass("added").addClass("load-more-overlay loading"), setTimeout(function () {
                    a.removeClass("load-more-overlay loading"), Wolmart.Minipopup.open({
                        ...
                        actionTemplate: '<a href="/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="checkout.html" class="btn btn-dark btn-rounded btn-sm">Checkout</a>'
                    })
                }, 500))
                ...
                s.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'), s = t(".page-wrapper > .compare-popup")), Wolmart.$body.on("click", ".product .btn-compare", function (o) {
                    ...
                    i.preventDefault();
                    var o = t(i.currentTarget).closest("li"), s = o.index(), r = o.find("img").attr("src");
            ...
            o || (o = "assets/front/products.html");
            var n = function (e) {
    ...
    var e = {
        ...
        a.hasClass("added") || (e.preventDefault(), a.addClass("load-more-overlay loading"), setTimeout(function () {
            a.removeClass("load-more-overlay loading").toggleClass("w-icon-heart").toggleClass("w-icon-heart-full")
        }, 500))
    };
    ...
    function o(e) {
        ...
        if (i.hasClass("disabled")) alert("Please select some product options before adding this product to your cart."); else {
            if (o.length) o.fadeOut(function () {
                ...
                var n = '<div class="alert alert-success alert-cart-product mb-2">                            ' +
                    '<a href="cart.html" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' + (a = i.closest(".product-single").find(".product-title").text()) + '” has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a>                            </div>';
    ...
    Wolmart.initProductSinglePage = function () {
        Wolmart.zoomImage(".product-gallery .product-image"), function (e) {
            ...
            var i = t(e), o = i.closest(".product-single"),
