...
//                dd($query->toSql());
                ...
                })->where('selling_price', '>', $min_price)->where('category_id', $category_id)->get();
...
//                dd($query->toSql());
                    ...
                    $min_price = $range[0];
                    $products = Product::with('category')->where('selling_price', '>', $min_price)->where('category_id', $category_id)->get();
